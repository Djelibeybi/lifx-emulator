...
- [Architecture Overview](overview.md) — How the protocol layer fits in
- [Packet Flow](packet-flow.md) — End-to-end packet processing
- [Device State](device-state.md) — State structures that handlers read and write
