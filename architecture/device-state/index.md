...
- [Architecture Overview](https://djelibeybi.github.io/lifx-emulator/architecture/overview/index.md) — Component relationships
- [Packet Flow](https://djelibeybi.github.io/lifx-emulator/architecture/packet-flow/index.md) — How handlers interact with state
- [Protocol Layer](https://djelibeybi.github.io/lifx-emulator/architecture/protocol/index.md) — Packet structures that carry state
